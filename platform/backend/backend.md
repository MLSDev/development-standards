...
* Ruby 3.2.x (latest stable)
* Ruby on Rails 7.x (latest stable)
* Ruby environment management: [rvm](http://rvm.io) / [asdf](https://asdf-vm.com)
...
* [Ruby Under a Microscope (by Pat Shaughnessy)](https://www.amazon.com/Ruby-Under-Microscope-Illustrated-Internals/dp/1593275277)
* [Metaprogramming Ruby (by Paolo Perrotta)](https://www.amazon.com/Metaprogramming-Ruby-Program-Like-Facets/dp/1941222129)
